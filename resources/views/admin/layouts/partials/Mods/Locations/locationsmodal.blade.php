    ...
    <div class="modal-body" id="modal_body_for_days_{{ $location->id }}">
        <form method="POST">
                            ...
                            <tbody>
                                @foreach ($location->location_hours as $dayshours)
                                    <tr id="hours_row_{{ $dayshours->id }}">
                                        ...
                                        <td><a href="#" onclick="editHoursRow({{ $dayshours->id }})"><i
            ...
            @else
                ...
                <div class="row" style="padding-bottom: 15px !important;">
                    <div class="col-md-4">
                        ...
                        <a class="btn btn-success btn-sm" id="add_hours_btn_edit_{{ $location->id }}" href="#" onclick="addHourstoEdit({{ $location->id }}, 0);">
            ...
            @endif
                <input type="hidden" name="loc_id" id="loc_id" value="{{ $location->id }}"/>
